 ...
 * @Author：stanzeng
 * @Description：
 * @Date ：Created in 2020/4/1 2:49 下午
 * @Modified By：
 */
public class RSAUtil {
    ...
    public static void genKeyPair() throws NoSuchAlgorithmException {
        ...
        KeyPairGenerator keyPairGen = KeyPairGenerator.getInstance(RSA_KEY);
    ...
    public static String encrypt(String str, String publicKey) throws Exception {
        ...
        RSAPublicKey pubKey = (RSAPublicKey) KeyFactory.getInstance(RSA_KEY).generatePublic(new X509EncodedKeySpec(decoded));
     ...
     * RSA私钥解密
     */
    public static String decrypt(String str, String priKeyStr) throws Exception {
        try {
